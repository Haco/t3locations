<?php
	...
	/** @var \S3b0\T3locations\Utility\AjaxDispatcher $dispatcher */
	$dispatcher = CoreUtility\GeneralUtility::makeInstance('S3b0\\T3locations\\Utility\\AjaxDispatcher');
