...
/**
 * Test case for class \S3b0\T3locations\Domain\Model\Map.
 *
...
class MapTest extends \TYPO3\CMS\Core\Tests\UnitTestCase {
	...
	protected function setUp() {
		$this->subject = new \S3b0\T3locations\Domain\Model\Map();
	}
	 ...
	 * @test
	 */
	public function getLinkQueryParamReturnsInitialValueForString() {
		$this->assertSame(
			'',
			$this->subject->getLinkQueryParam()
		);
	}
	 ...
	 * @test
	 */
	public function setLinkQueryParamForStringSetsLinkQueryParam() {
		$this->subject->setLinkQueryParam('Conceived at T3CON10');
